...
public final class GridListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView Leroy;

  @NonNull
  public final TextView Name;

  private GridListItemBinding(@NonNull MaterialCardView rootView, @NonNull TextView Age,
      @NonNull TextView Hobbis, @NonNull ImageView Leroy, @NonNull TextView Name) {
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.Leroy;
      ImageView Leroy = ViewBindings.findChildViewById(rootView, id);
      if (Leroy == null) {
        break missingId;
      }
      ...
      return new GridListItemBinding((MaterialCardView) rootView, Age, Hobbis, Leroy, Name);
    }
